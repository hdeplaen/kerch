...
mdl = kerch.rkm.multiview.MVKPCA(
    {"name": "space", "type": "random_features", "num_weights": NUM_WEIGHTS, "center": False, "sample": train_y},
    {"name": "time", "type": "random_features", "base_type": "rbf", "num_weights": NUM_WEIGHTS, "center": False, "normalize": False,
     "sample": train_x},
