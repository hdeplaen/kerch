...
def generate_dataset(fun, tr_size, val_size, test_size, tot_data, test_data):
    ...
    assert tot_data != 0, "Cannot select no value."
...
def factory(name, tr_size=100, val_size=0, test_size=0):
    datasets = {"gaussians": (gaussians, None, None),
                "spiral": (spiral, None, None),
                "two_moons": (two_moons, None, None),
                "usps": (usps, 5000, None),
                "pid": (pima_indians, 767, None),
