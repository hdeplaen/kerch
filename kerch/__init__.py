...
__all__ = ['__version__', '__author__', '__credits__', '__status__', '__date__', '__license__',
           'kernel', 'level', 'model', 'data', 'train', 'opt', 'set_log_level', 'get_log_level', 'gpu_available',
           'set_ftype', 'set_itype', 'DEFAULT_KERNEL_TYPE', 'DEFAULT_CACHE_LEVEL']
...
from . import watch as watch             # alpha
from . import plot as plot
from . import opt as opt  # beta
from . import script as script # alpha
from .module.Logger import (set_log_level as set_log_level,
