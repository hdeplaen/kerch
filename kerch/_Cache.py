...
class _Cache(_Module,
    ...
    _cache_level_switcher = switcher = {"oblivious": 0,
                                       "lightweight": 1,
                                       "normal": 2,
                                       "heavy": 3,
                                       "total": 4}
    ...
    def cache_level(self) -> str:
        ...
        * `"lightweight"`: the cache is very light. For example, only the kernel matrix and statistics of the sample points are saved.
