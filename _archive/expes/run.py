...
from _archive.expes.tests import Suites
from _archive.expes.data import data
from _archive.model import rkm as rkm
...
def general_expe(name, verbose=False):
    ...
    data_params = {**default_data_params, **params['value']}
