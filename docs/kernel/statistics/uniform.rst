...
.. autoclass:: kerch.kernel.Uniform
    :members:
...
.. plot::
    ...
    k1 = kerch.kernel.Uniform(sample=sample, sigma=1.5)
    k2 = kerch.kernel.Uniform(sample=sample, distance='chebyshev', sigma=1.5)
