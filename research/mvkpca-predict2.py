...
plt.figure()
plt.plot(x.cpu().squeeze(), y.cpu().squeeze(), 'k1--', label='Original function', lw=1)
plt.plot(oos_x[:round(NUM_POINTS/2)].cpu().squeeze(), oos_y[:round(NUM_POINTS/2)].cpu().squeeze(), 'k1--', lw=1)
plt.plot(oos_x[round(NUM_POINTS/2):].cpu().squeeze(), oos_y[round(NUM_POINTS/2):].cpu().squeeze(), 'k1--', lw=1)
